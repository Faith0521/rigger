...
from ... import skinUtils

reload(skinUtils)

class SkinExportWidget(QtWidgets.QWidget):
    def __init__(self,
                 toolbox):
    ...
    def _createInjectionWidget(self):
        injectionWidget = QtWidgets.QGroupBox('')

        layout = QtWidgets.QHBoxLayout()
        layout.setContentsMargins(10, 5, 5, 5)

        self.injectionModeComboBox = QtWidgets.QComboBox(self)
        self.injectionModeComboBox.setMinimumWidth(540)
        injectionModel = QtCore.QStringListModel()
        ...
        layout.addWidget(QtWidgets.QLabel('Injection Mode:'))
    ...
    def _createWeightFileControls(self):
        self.weightTargetPath = QtWidgets.QLineEdit(self)

        weightPathWidget = QtWidgets.QGroupBox("Output weights file:")
        pickButton = QtWidgets.QPushButton('')
        layout = QtWidgets.QHBoxLayout()
    ...
    def _pickOutputfile(self):
        targetFile, pathFilter = QtWidgets.QFileDialog.getSaveFileName(caption="Please choose your target path for your weights",filter="*.zip" )
    ...
    def _saveSelectedObjectWeights(self):
        ...
        self.skinManager.exportAssetWeights(cmds.ls(sl=True),
                                            outputPath,
