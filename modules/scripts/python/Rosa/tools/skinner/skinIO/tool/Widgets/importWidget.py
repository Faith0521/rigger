...
class SkinImportWidget(QtWidgets.QWidget):
    def __init__(self,
                 toolbox):
    ...
    def setupUi(self):
        ...
        importButton = QtWidgets.QPushButton('Load weights')
    ...
    def _createWeightFileControls(self):
        self.weightSourcePath = QtWidgets.QLineEdit(self)

        weightPathWidget = QtWidgets.QGroupBox("Input weights file:")
    ...
    def _pickOutputfile(self):
        targetFile, pathFilter = QtWidgets.QFileDialog.getOpenFileName(caption="Please choose your input weights file",filter="*.zip" )
