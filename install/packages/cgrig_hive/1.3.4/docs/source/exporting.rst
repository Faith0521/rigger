...
You probably want to check out :class:`ExportPlugin<cgrig.libs.hive.base.exporterplugin.ExporterPlugin>`
...
Now reload cgrig/maya and let's run the code to access and run the export but instead of specifying "myExporter"
