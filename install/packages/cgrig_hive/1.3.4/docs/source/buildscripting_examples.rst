...
- `/cgrig_preferences/assets/hive/buildscripts/`
...
Common CMDS/CgRig Python Examples
####################################################
...
.. code-block:: python
    ...
    #Create Attribute (cgrig helper) "bool", "int", "str"
    ...
    # Create Attribute (cgrig helper) "enum"
    from cgrig.libs.maya.cmds.objutils import attributes
    ...
    from cgrig.libs.maya.cmds.objutils import layers
