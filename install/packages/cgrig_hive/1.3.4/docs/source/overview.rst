...
However, because the Maya API 2.0 is not undoable, the Hive API includes CgRigCommands,
...
For more information about cgrigCommands please refer to :ref:`CgRigCommands <mayaCommands>`.
