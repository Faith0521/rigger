...
API Reference: :class:`cgrig.libs.hive.base.component.Component`
...
API Class :class:`cgrig.libs.hive.base.definition.GuideDefinition`
...
Next on the table is the :class:`cgrig.libs.hive.base.definition.JointDefinition`
...
Next on the table is the :class:`cgrig.libs.hive.base.definition.InputDefinition`
...
Next on the table is the :class:`cgrig.libs.hive.base.definition.OutputDefinition`
...
Attributes
**********
Currently we have a single generic :class:`AttributeDefinition<cgrig.libs.hive.base.definition.definitionattrs.AttributeDefinition>`
though we're likely to extend this for all attribute Types in the near future.

We support a wide variety of maya attribute types which you can see :mod:`cgrig.libs.maya.api.attrtypes`
...
.. code-block:: json

    {
        ...
        "parent": "",
        "connections": {},
        "path": "cgrig\\libs\\hive\\library\\components\\myComponent.py"
    }
