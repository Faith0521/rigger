...
In my case i'll create it under `cgrig_preferences/assets/hive/buildScripts`
...
This is what the :func:`Properties<cgrig.libs.hive.base.buildscript.BaseBuildScript.properties>` is for.
