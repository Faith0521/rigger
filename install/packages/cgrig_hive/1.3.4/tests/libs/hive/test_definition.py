...
from cgrig.libs.hive.base.definition import spaceswitch
...
class TestSpaceSwitching(mayatestutils.BaseMayaTest):
    ...
    def test_serializationMaintainsNewOrdering(self):
        ...
        diff = spaceswitch.SpaceSwitchDefinition(serializedData.serialize())
        ...
        self.assertIsNone(self.spaceDef.difference(self.spaceDef),
    ...
    def test_defaultDriverIsDifferent(self):
        newSpaceSwitch = spaceswitch.SpaceSwitchDefinition(self.spaceDef.serialize())
        newSpaceSwitch.defaultDriver = "world"
        self.assertEqual(newSpaceSwitch.defaultDriver, "world")
        self.assertIsNotNone(self.spaceDef.difference(newSpaceSwitch))
