...
class ExporterPlugin(object):
    ...
    def validate(self, rig, exportOptions):
        """PreFlight Method to validate the scene and rig before exporting.
        ...
        :type exportOptions: :class:`cgrig.libs.utils.general.ObjectDict`
        :rtype: :class:`cgrig.libs.hive.base.errors.ValidationRigInfo`
        """
        return errors.ValidationRigInfo(rig)
