...
class BuildGuideCommand(command.CgRigCommandMaya):
...
class BuildGuidesControlsCommand(command.CgRigCommandMaya):
...
class DeleteComponentGuideCommand(command.CgRigCommandMaya):
