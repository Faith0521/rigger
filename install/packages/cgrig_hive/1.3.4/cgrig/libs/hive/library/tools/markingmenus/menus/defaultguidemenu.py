...
class BaseHiveGuideMM(menu.MarkingMenuDynamic):
    ...
    def execute(self, layout, arguments):
        ...
        generic = [
            ...
            {"type": "separator"},
            {"type": "command", "id": "hiveDeleteComponent", "arguments": arguments},
            {"type": "separator"},
            {
            ...
            },
            {
                ...
                "id": "hiveToggleVisibility",
                "arguments": {
                    "visibilityType": "Annotations",
                    "rig": rig,
                    "components": components,
                },
            },
            {"type": "command", "id": "hiveComponentGuidePin", "arguments": arguments},
            {"type": "command", "id": "toggleGuideXray", "arguments": arguments},
            {"type": "command", "id": "toggleLra", "arguments": arguments},
            {"type": "separator"},
            {
                "type": "command",
