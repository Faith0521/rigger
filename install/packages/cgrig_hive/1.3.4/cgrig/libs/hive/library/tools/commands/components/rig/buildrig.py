...
class ToggleBuildComponentGuideCommand(command.CgRigCommandMaya):
...
class BuildComponentRigCommand(command.CgRigCommandMaya):
...
class DeleteComponentRigCommand(command.CgRigCommandMaya):
    """Builds the component rig
