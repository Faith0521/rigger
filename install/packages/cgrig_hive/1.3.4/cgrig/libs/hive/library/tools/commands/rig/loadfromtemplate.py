...
class LoadFromTemplate(command.CgRigCommandMaya):
...
class SaveTemplate(command.CgRigCommandMaya):
    ...
    def doIt(self, rig=None, name=None, components=None, overwrite=True, folderPath=None):
        """
...
class DeleteTemplate(command.CgRigCommandMaya):
