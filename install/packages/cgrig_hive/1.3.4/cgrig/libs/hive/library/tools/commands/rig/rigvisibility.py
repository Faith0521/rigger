...
class ShowRigCommand(command.CgRigCommandMaya):
...
class HideRigCommand(command.CgRigCommandMaya):
...
class ToggleRigVisibilityCommand(command.CgRigCommandMaya):
...
class HideShowDeformVisibilityCommand(command.CgRigCommandMaya):
