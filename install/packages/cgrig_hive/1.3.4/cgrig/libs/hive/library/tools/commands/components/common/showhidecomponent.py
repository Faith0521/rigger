...
class ShowComponentCommand(command.CgRigCommandMaya):
    """Shows the Component
    """
...
class HideComponentCommand(command.CgRigCommandMaya):
    """Hide the component
    """
...
class ToggleComponentVisibilityCommand(command.CgRigCommandMaya):
