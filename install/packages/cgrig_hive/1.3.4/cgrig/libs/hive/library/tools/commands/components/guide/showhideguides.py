...
class ShowGuidesCommand(command.CgRigCommandMaya):
...
class HideGuidesCommand(command.CgRigCommandMaya):
...
class ToggleGuideVisibilityCommand(command.CgRigCommandMaya):
    ...
    def resolveArguments(self, arguments):
        ...
        if not visible:
            arguments['visible'] = rig.configuration.guidePivotVisibility
...
class ToggleRigGuideShapeVisibilityCommand(command.CgRigCommandMaya):
...
class ToggleRigGuideVisibilityCommand(command.CgRigCommandMaya):
...
class SetComponentLRACommand(command.CgRigCommandMaya):
    ...
    def doIt(self, components=None, visibility=True):
        ...
        :type components: iterable[:class:`cgrig.libs.hive.base.component.Component`]
...
class ShowGuidesFromSelectedCommand(command.CgRigCommandMaya):
    """Shows all the guides in for this component
    """
    ...
    def doIt(self, components=None, fullRig=False):
        ...
        :type components: :class:`list`(:class:`cgrig.libs.hive.base.component.Component`)
        :return: True if successful
        :rtype: bool
        """
...
class HideGuidesFromSelectedCommand(command.CgRigCommandMaya):
    """Shows all the guides in for this component
    """
...
class ToggleGuideVisibilityFromSelectedCommand(command.CgRigCommandMaya):
    """Shows all the guides in for this component
    """
