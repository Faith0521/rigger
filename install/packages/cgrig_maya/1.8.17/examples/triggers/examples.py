...
class CustomSelectionTrigger(triggers.TriggerSelectionBase):
    ...
    .. code-block:: python
        # first register this plugin path before cgrig loads or load cgrig afterwards
        os.environ["CGRIG_TRIGGER_COMMAND_PATH"] += ";currentPath to example/"
        # now reload or start cgrig
