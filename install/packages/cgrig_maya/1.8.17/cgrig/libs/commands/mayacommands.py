...
def resetTransforms(nodes, translate=True, rotate=True, scale=True):
    ...
    """
    return executor.execute("cgrig.nodes.resetTransform", **locals())


def matchTransforms(nodes, translate=True, rotate=True, scale=True):
    return executor.execute("cgrig.maya.matchTransforms", **locals())


def matchTransformsBake(nodes, translate=True, rotate=True, scale=True,
                        bakeEveryFrame=False, frameRange=None):
    return executor.execute("cgrig.maya.matchTransformsBake", **locals())
...
def coPlanarAlign(create=False, align=False, metaNode=None, skipEnd=False):
    ...
    :type metaNode: :class:`cgrig.libs.maya.meta.coplanar.CoPlanarMeta`
    ...
    :rtype: bool or :class:`cgrig.libs.maya.meta.coplanar.CoPlanarMeta`
    """
    ...
    return executor.execute("cgrig.maya.planeOrient", **locals())
...
def orientNodes(nodes,
    ...
    :type skipEnd: bool
    """
    return executor.execute("cgrig.maya.orientNodes", **locals())
