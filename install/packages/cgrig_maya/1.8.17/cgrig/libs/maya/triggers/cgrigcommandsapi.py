...
Each function simply calls the matching cgrigCommand
"""
...
def createMenuTriggers(nodes, menuId, triggerCommandId=None):
    ...
    :rtype: list[:class:`cgrig.libs.maya.triggers.TriggerNode`]
    """
    return executor.execute("cgrig.maya.createMenuTriggers",
                            nodes=nodes,
...
def createSelectionTrigger(nodes, commandStr=None, connectables=None, triggerCommandId=None):
    ...
    :rtype: list[:class:`cgrig.libs.maya.triggers.TriggerNode`]
    """
    return executor.execute("cgrig.maya.createSelectionTriggers",
                            nodes=nodes,
...
def deleteTriggers(nodes):
    ...
    :type nodes: list[:class:`zapi.DGNode`]
    """
    return executor.execute("cgrig.maya.deleteTriggers",
                            nodes=nodes)
