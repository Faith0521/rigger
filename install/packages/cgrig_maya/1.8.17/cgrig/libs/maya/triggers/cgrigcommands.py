...
class CreateMenuTriggersCommand(command.CgRigCommandMaya):
    """This command creates a TriggerMenu for each node provided.
    """

    id = "cgrig.maya.createMenuTriggers"
    isUndoable = True
    modifier = None
...
class DeleteTriggersCommand(command.CgRigCommandMaya):
    """The Command deletes the current trigger on all specified nodes
    """

    id = "cgrig.maya.deleteTriggers"
    isUndoable = True
...
class CreateSelectionTriggersCommand(command.CgRigCommandMaya):
    """The Command creates selection based trigger command for each node provided.
    """

    id = "cgrig.maya.createSelectionTriggers"
    isUndoable = True
    modifier = None
    _triggers = []
