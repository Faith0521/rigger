...
from cgrig.libs.maya.api import anim, constants
...
def allGimbalTolerances(obj, frames=None, step=1):
    ...
    :type obj: :class:`cgrig.libs.maya.zapi.DagNode`
    ...
    with autoKeyKeyFrameContext(False):
        ...
        try:
            if frames:
                ...
                tolerances = [cgrigmath.mean([frame[i] for frame in totalTolerances]) for i in constants.kRotateOrders]
            else:
