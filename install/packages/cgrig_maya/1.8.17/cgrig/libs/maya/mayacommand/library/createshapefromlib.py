...
class CreateCurveFromLibrary(command.CgRigCommandMaya):
    """This command Creates a nurbs curve from the shapelib
    """
    id = "cgrig.maya.curves.createFromLib"
    isUndoable = True
...
class CreateCurveFromFilePath(command.CgRigCommandMaya):
    """This command Creates a nurbs curve from a folder path and shape designName
    """
    id = "cgrig.maya.curves.createFromFilePath"
