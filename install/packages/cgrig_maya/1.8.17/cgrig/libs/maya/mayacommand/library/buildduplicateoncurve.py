...
from cgrig.libs.maya.cmds.rig import duplicatealongcurve
from maya.api import OpenMaya as om2


class BuildDuplicateOnCurveCommand(command.CgRigCommandMaya):
    """This command Creates a meta node from the registry.
    """
    id = "cgrig.maya.duplicateoncurve.build"
    isUndoable = True
    disableQueue = True
    _modifier = None
    ...
    def doIt(self, meta=None, sourceObjects=None, curve=None, rename=True):
        ...
        :param meta:
        :type meta: cgrig.libs.maya.cmds.meta.metaduplicateoncurve.MetaDuplicateOnCurve
        :param sourceObjects:
        :type sourceObjects:
        :param curve:
        :type curve:
