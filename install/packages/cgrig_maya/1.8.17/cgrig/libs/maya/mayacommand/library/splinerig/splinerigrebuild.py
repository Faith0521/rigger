...
from cgrig.libs.maya.mayacommand.library.splinerig import splinerigbake, splinerigdelete, splinerigbuild


logger = zlogging.getLogger(__name__)


class SplineRigRebuildCommand(command.CgRigCommandMaya):
    """This command rebuilds the spline rig
    """
    id = "cgrig.maya.splinerig.rebuild"
    isUndoable = True
