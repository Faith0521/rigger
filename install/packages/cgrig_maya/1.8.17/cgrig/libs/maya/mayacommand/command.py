...
class CommandInterface(object):
    """The standard CgRigCommand metaclass interface. Each command must implement doIt, id, creator, isUndoable, description
    """
...
class CgRigCommandMaya(CommandInterface):
    isEnabled = True
