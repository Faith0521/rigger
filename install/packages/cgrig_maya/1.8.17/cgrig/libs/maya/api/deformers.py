...
skinObject = SkinCluster(skinCluster)
skinObject.influenceWeights()
...
class SkinCluster(object):
    ...
    def influenceWeights(self):
        ...
        componentsPerInfluence = int(len(weights) / influenceCount)
        influenceData = {}
        for i in range(influenceCount):
            partialName = generic.stripNamespaceFromName(influences[i].fullPathName())
            influenceData[partialName] = [weights[int(g * influenceCount + i)] for g in range(componentsPerInfluence)]
...
def skinClustersFromJoints(joints):
    ...
    :type joints: list[:class:`cgrig.libs.maya.zapi.base.DagNode or cgrig.libs.maya.zapi.base.DGNode`]
    :return: the retrieved skin clusters from the joints
    :rtype: list[:class:`cgrig.libs.maya.zapi.base.DagNode or cgrig.libs.maya.zapi.base.DGNode`]
    """
    ret = []
    for j in joints:
...
def skinClustersFromJoint(joint):
    ...
    :type joint: :class:`cgrig.libs.maya.zapi.base.DagNode or cgrig.libs.maya.zapi.base.DGNode`
    :return:
    :rtype: list[:class:`cgrig.libs.maya.zapi.base.DagNode or cgrig.libs.maya.zapi.base.DGNode`]
    """
...
def skinClustersConnectedMeshes(skinClusters):
    ...
    :type skinClusters: list[:class:`cgrig.libs.maya.zapi.base.DagNode or cgrig.libs.maya.zapi.base.DGNode`]
    :return nodes: The connected meshes
    :rtype nodes: list[:class:`cgrig.libs.maya.zapi.base.DagNode or cgrig.libs.maya.zapi.base.DGNode`]
    """
    nodes = []
