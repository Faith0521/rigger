...
from cgrig.libs.maya.cmds.meta.metafocuspuller import A_REDSHIFT_BOKEH
...
CAM_ATTRS = ["RsRadius", "RsPower", "RsAspect", "RsBladeCount", "RsBladeAngle"]


class CgRigFocusPullerRedshift(metafocuspuller.CgRigFocusPuller):
    """
    """
    ...
    def proxyAttribute(self):
        ...
        attributes.addProxyAttribute(camera_name, bokeh_node, "dofBladeCount", proxyAttr="RsBladeCount",
                                     channelBox=True)
        attributes.addProxyAttribute(camera_name, bokeh_node, "dofBladeAngle", proxyAttr="RsBladeAngle",
                                     channelBox=True)
    ...
    def buildRig(self, camera_name):
        ...
        :rtype:
        """
        super(CgRigFocusPullerRedshift, self).buildRig(camera_name)
        # create RS node
...
def buildRigSetup(camera_name):
    ...
    metafocuspuller.remove_focusAttrs(camera_name, CAM_ATTRS + metafocuspuller.CAM_DEFAULT_ATTRS)

    meta = CgRigFocusPullerRedshift()
