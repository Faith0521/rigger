# -*- coding: utf-8 -*-
"""This module is the Renderman class for directional lights
...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.lighting.directionaltypes import rendermandirectional
    directionalInst = rendermandirectional.RendermanDirectional("directionalLightName", create=True)  # creates a new Directional light
    ...
    directionalInst = rendermandirectional.RendermanDirectional(name="existingDirectionalLight", create=False, ingest=True)  # ingest existing light
...
NODE_TYPE = "PxrDistantLight"


class RendermanDirectional(directionalbase.DirectionalBase):
    ...
    softAngleAttr = "angleExtent"

    intensityMultiply = 46000.0
    scaleMultiply = 0.2
    ...
    def __init__(self, name="", genAttrDict=None, node=None, create=False, ingest=False, suffixName=False,
        ...
        :type message: bool
        """
        super(RendermanDirectional, self).__init__(name=name,
