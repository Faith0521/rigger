...
from cgrig.libs.maya.cmds.objutils import filtertypes, namehandling, selection, shapenodes, objhandling
from cgrig.libs.maya.cmds.modeling import subdivisions, components

try:
    from cgrig.libs.buliarcacristian import lockNormals_toHS
except:
    pass
...
def unlockVertexNormalsObj(obj):
    ...
    try:
        ...
        output.displayWarning("Could not maintain smoothing with Community Script: "
                              "cgrig.libs.buliarcacristian.lockNormals_toHS")
