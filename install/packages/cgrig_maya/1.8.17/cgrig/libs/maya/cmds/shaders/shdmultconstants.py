...
from cgrig.libs.maya.cmds.shaders import shdmultconstants
...
from cgrig.libs.maya.cmds.renderer import rendererconstants

MAYA_VERSION = float(mayaenv.mayaVersionNiceName())  # Float 2019.1
...
# Maya Shaders ----------------
OPEN_PBR_SURFACE = "openPBRSurface"
...
elif MAYA_VERSION < 2025.3:
    MAYA_DEFAULT_SHADER = STANDARD_SURFACE
else:
    MAYA_DEFAULT_SHADER = OPEN_PBR_SURFACE

# Shader Lists ---------------------
if MAYA_VERSION < 2020:  # 2019 and below
    ...
    MAYA_SHADER_LIST = [OPEN_PBR_SURFACE, STANDARD_SURFACE, LAMBERT, BLINN, PHONG, PHONGE]
    SHADER_TYPE_LIST = [OPEN_PBR_SURFACE, STANDARD_SURFACE, LAMBERT, BLINN, PHONG, PHONGE, AI_STANDARD_SURFACE,
                        VRAY_MTL, REDSHIFT_MATERIAL, PXR_SURFACE]
...
if MAYA_VERSION < 2020:  # 2019 and below
    ...
    SHADERTYPE_SUFFIX_DICT = {OPEN_PBR_SURFACE: PBR_SUFFIX,
                              STANDARD_SURFACE: STRD_SUFFIX,
                              AI_STANDARD_SURFACE: ARN_SUFFIX,
                              VRAY_MTL: VRAY_SUFFIX,
                              REDSHIFT_MATERIAL: RS_SUFFIX,
                              PXR_SURFACE: PXR_SUFFIX,
...
if MAYA_VERSION < 2020:
    ...
    SHADERTYPE_RENDERER = {OPEN_PBR_SURFACE: MAYA,
                           STANDARD_SURFACE: MAYA,
                           AI_STANDARD_SURFACE: ARNOLD,
                           VRAY_MTL: VRAY,
                           REDSHIFT_MATERIAL: REDSHIFT,
                           PXR_SURFACE: RENDERMAN,
...
DISP_ATTR_RENDERER = "cgrigRenderer"

# Displacement Network globals, network names and attributes
NW_DISPLACE_NODE = "cgrigDisplacementNetwork"
NW_DISPLACE_MESH_ATTR = "cgrigDisplaceMeshConnect"
NW_DISPLACE_SG_ATTR = "cgrigDisplaceSGConnect"
NW_DISPLACE_FILE_ATTR = "cgrigDisplaceFileConnect"
NW_DISPLACE_PLACE2D_ATTR = "cgrigDisplacePlace2dConnect"
NW_DISPLACE_NODE_ATTR = "cgrigDisplaceNode"
