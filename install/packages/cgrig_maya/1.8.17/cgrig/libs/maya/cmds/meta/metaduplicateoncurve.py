...
from cgrig.libs.maya.cmds.objutils import filtertypes, namehandling
from cgrig.libs.maya.cmds.rig import splines, duplicatealongcurve
...
class MetaDuplicateOnCurve(base.MetaBase):
    ...
    def buildSelected(self):
        ...
        executor.execute("cgrig.maya.duplicateoncurve.build",
