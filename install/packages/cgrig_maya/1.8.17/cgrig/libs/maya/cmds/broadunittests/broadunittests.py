# -*- coding: utf-8 -*-
"""
Broad Unit Tests cgrig code roughly by creating and deleting objects rigs scenes etc to see if anything \
...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.broadunittests import broadunittests
...
from cgrig.libs.maya.cmds.broadunittests import testuis
from cgrig.libs.maya.cmds.broadunittests import testcmdsrigging
