...
from cgrig.libs.maya.utils.files import mayaFileType

from cgrig.libs.maya.cmds.shaders import createshadernetwork
from cgrig.libs.maya.cmds.objutils import namewildcards, namehandling, filtertypes, selection
from cgrig.libs.maya.cmds.renderer.rendererconstants import RENDERER_SUFFIX_DICT, DEFAULT_MAYA_SHADER_TYPES
from cgrig.libs.maya.utils import scene, general
from cgrig.libs.pyqt.widgets import elements
from cgrig.libs.utils import output, path as zpath
from cgrig.core.util import zlogging, strutils
...
class CgRigShaderTrackerSingleton(object):
