...
from cgrig.libs.maya.cmds.objutils import joints, namehandling, attributes
from cgrig.libs.maya.cmds.rig import splines, deformers, axis
...
class SplineBuilder(object):
    ...
    def _ikHandleData(self, ikHandle):
        ...
        :param ikHandle:
        :type ikHandle: :class:`cgrig.libs.maya.zapi.base.DagNode`
        :return:
        :rtype:
        """
