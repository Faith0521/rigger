...
Run from inside
    cgrig.libs.maya.cmds.shaders.standalone.standalone_runconvert.py

Or run as a standalone script from a bat file such as
    set MAYA_APP_DIR=D:\repos\mayaPrefs\cgrig_v2
    set MAYA_MODULE_PATH=D:\repos\cgrigtools_pro\modules
