# -*- coding: utf-8 -*-
"""
from cgrig.libs.maya.cmds.hotkeys import hotkeyexample
...
from cgrig.libs.maya.cmds.objutils import cleanup, selection
from cgrig.libs.maya.cmds.modeling import pivots
...
class MyPopupToolbar(elements.CgRigWindowThin):
