...
from cgrig.libs.maya.cmds.shaders import buildtexturedshader
...
FOLDER_PATH = "D:/Dropbox/cgrig_assets_silky/textures/Bricks074_1K-JPG"
...
def buildTexturedShader(textureDict, shaderType="standardSurface", shaderName=""):
    ...
    :return shdInstance: A CgRig shader instance object
    :rtype shaderInstance: :class:`cgrig.libs.maya.cmds.shaders.shadertypes.shaderbase.ShaderBase`
