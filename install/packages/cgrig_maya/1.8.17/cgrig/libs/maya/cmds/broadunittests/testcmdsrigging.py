...
def testSplineRig():
    ...
    splineRigMeta = executor.execute("cgrig.maya.splinerig.build", metaAttrs=metaAttrs, buildType=0)  # type: metasplinerig.MetaSplineRig
    ...
    splineRigMeta = executor.execute("cgrig.maya.splinerig.rebuild", meta=splineRigMeta, metaAttrs=metaAttrs, bake=False)
    ...
    executor.execute("cgrig.maya.splinerig.delete", meta=splineRigMeta, deleteAll=True)
