...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.lighting.areatypes import mayaarea
...
class MayaArea(areabase.AreaBase):
    ...
    def setIntensity(self, intensity):
        ...
        self.setIntensityPure(intensityVal*self.intensityMultiply)  # ignores the cgrig intensity tracker attrs
