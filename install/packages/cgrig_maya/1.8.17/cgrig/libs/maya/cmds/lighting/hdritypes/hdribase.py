...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.lighting.hdritypes import hdribase
...
from cgrig.libs.maya.cmds.lighting.lightconstants import HDRI_NAME, HDRI_INTENSITY, HDRI_LIGHTVISIBILITY, \
...
BACKGROUND_VIS_ATTR = ""
TINT_COLOR_ATTR = ""
INTENSITY_MULTIPLY_ATTR = "cgrigIntensityMultiply"
ROTATE_OFFSET_ATTR = "cgrigRotateOffset"
...
class HdriBase(lightsbase.LightsBase):
    ...
    # -------------------
    # Intensity Multiplier --- Optional custom cgrig attributes added to the HDRI shape node
    # -------------------

    def setIntensityMultiply(self, intensityMultiply):
        """Sets the cgrig intensity multiply attribute, this is a custom attribute and will create it if it doesn't exist.

        IntensityMultiply is an optional custom attribute controlled by the CgRig HDRI Skydome UI
    ...
    def intensityMultiply(self):
        """Returns the value of the cgrig intensity multiply custom attribute.  Will return None if it doesn't exist.
    ...
    # -------------------
    # Rotation Offset --- Optional custom cgrig attributes added to the HDRI shape node
    # -------------------

    def setRotateOffset(self, rotateOffset):
        """Sets the cgrig rotate offset attribute, this is a custom attribute and will create it if it doesn't exist.

        RotateOffset is an optional custom attribute controlled by the CgRig HDRI Skydome UIs
    ...
    def rotateOffset(self):
        """Returns the value of the cgrig rotate offset custom attribute.  Will return None if it doesn't exist.
