...
from cgrig.libs.maya.cmds.meta import metafocuspuller, metaadditivefk
...
class FocusPullerMarkingMenuCommand(menu.MarkingMenuCommand):
    ...
    def uiData(arguments):
        ...
        #if op == "switchSpace":
        #    meta = base.metaNodeFromZApiObjects(arguments['nodes'])[-1]  # type: CgRigFocusPuller
    ...
    def execute(self, arguments):
        ...
        :type arguments: dict
        """
        metaNodes = base.metaNodeFromZApiObjects(arguments['nodes'])[-1]  # type: CgRigFocusPuller
