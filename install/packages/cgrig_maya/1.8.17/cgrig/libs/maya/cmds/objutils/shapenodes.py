...
from cgrig.libs.maya.cmds.objutils import filtertypes, namehandling, objhandling, matrix
...
def matchTransformForShapeReparent(node):
    ...
    tempNode = cmds.group(empty=True, name="{}_tempCgRigXX".format(nodeShortName))
