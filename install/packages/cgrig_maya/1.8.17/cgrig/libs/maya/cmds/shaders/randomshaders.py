...
from cgrig.libs.maya.cmds.shaders import shadermulti, shaderutils
...
class RandomShader(object):
    ...
    def __init__(self):
        ...
        Code example:
            ...
            from cgrig.libs.maya.cmds.shaders import randomshaders
    ...
    def useShaders(self):
        ...
        if texturesFound:
            ...
            output.displayInfo("Information: Please select objects. Note colors cannot be changed. "
                                  "CgRig unsupported shader/s have been added {}.".format(uknownShaders))
        else:
