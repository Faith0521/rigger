...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.shaders.shadertypes import redshiftredshiftmaterial
...
from cgrig.libs.maya.cmds.shaders import redshiftshaders, shdmultconstants
