...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.shaders.shadertypes import rendermanpxrlayersurface
...
from cgrig.libs.maya.cmds.shaders import rendermanshaders, shdmultconstants
