...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.lighting.directionaltypes import arnolddirectional
    directionalInst = arnolddirectional.ArnoldDirectional("directionalLightName", create=True)  # creates a new Directional light
    ...
    directionalInst = arnolddirectional.ArnoldDirectional(name="existingDirectionalLight", create=False, ingest=True)  # ingest existing light
...
class ArnoldDirectional(directionalbase.DirectionalBase):
    ...
    colorAttr = "color"
    tempBoolAttr = "aiUseColorTemperature"
    temperatureAttr = "aiColorTemperature"
    ...
    def __init__(self, name="", genAttrDict=None, node=None, create=False, ingest=False, suffixName=False,
        ...
        :type message: bool
        """
        super(ArnoldDirectional, self).__init__(name=name,
    ...
    def create(self, message=True):
        super(ArnoldDirectional, self).create(message=True)
