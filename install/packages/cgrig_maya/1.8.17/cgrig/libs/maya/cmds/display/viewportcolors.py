...
from cgrig.libs.maya.utils.mayacolors import CGRIG_BG_COLORS_LINEAR  # The color list to cycle cycleBackgroundColorsCgRig()
...
def cycleBackgroundColorsCgRig():
    """Cycles the background colors like maya alt b only with two more dark background colors.

    See mayacolors.CGRIG_BG_COLORS_LINEAR for the color list in linear float
    """
    cycleBackgroundColors(CGRIG_BG_COLORS_LINEAR)
