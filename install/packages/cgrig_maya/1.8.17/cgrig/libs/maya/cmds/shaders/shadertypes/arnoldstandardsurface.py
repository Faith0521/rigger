...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.shaders.shadertypes import arnoldstandardsurface
...
from cgrig.libs.maya.cmds.shaders import arnoldshaders, shdmultconstants
from cgrig.libs.maya.cmds.shaders.shadertypes import shaderbase
...
class AiStandardSurface(shaderbase.ShaderBase):
    ...
    def __init__(self, shaderName="", node=None, genAttrDict=None, create=False, ingest=False, suffixName=False,
        ...
        :type node: cgrig.libs.maya.zapi.base.DGNode
    ...
    def knownShader(self):
        """Returns True as this shader is supported by CgRig Tools

        :return: True if this shader is supported by CgRig Tools Flase if not.
        :rtype: bool
        """
        return True
    ...
    def renderer(self):
        ...
        :return: Returns the current renderer as a string in this case "Arnold".
        :rtype: str
        """
        return shdmultconstants.ARNOLD
    ...
    def diffuseWeight(self):
        ...
        :return: The diffuse weight value 0-1.0, None if textured/connected
        :rtype: float
        """
    ...
    def diffuse(self):
        ...
        :return: The diffuse color as linear float rgb (0.1, 0.5, 1.0), None if textured/connected
        :rtype: list(float)
        """
    ...
    def metalness(self):
        ...
        :return: The metalness value 0-1.0, None if textured/connected
        :rtype: float
        """
    ...
    def specWeight(self):
        ...
        :return:  Specular Weight value 0-1.0, None if textured/connected
        :rtype: float
        """
    ...
    def specColor(self):
        ...
        :return: Specular color as rendering space float rgb (0.5, 1.0, 0.0), None if textured/connected
        :rtype: list(float)
        """
    ...
    def specIOR(self):
        ...
        :return: The specular IOR value, 1.0 - 20.0, None if textured/connected
        :rtype: float
        """
    ...
    def coatWeight(self):
        ...
        :return: The clear coat weight value 0-1.0, None if textured/connected
        :rtype: float
        """
    ...
    def coatColor(self):
        ...
        :return: Clear coat color as rendering space float rgb (0.5, 1.0, 0.0), None if textured/connected
        :rtype: list(float)
        """
    ...
    def coatRoughness(self):
        ...
        :return: The clear coat roughness value 0 -1.0, None if textured/connected
        :rtype: float
        """
    ...
    def coatIOR(self):
        ...
        :return: The clear coat IOR value, 1.0 - 20.0, None if textured/connected
        :rtype: float
        """
    ...
    def emission(self):
        ...
        :return: Emission color as rendering space float rgb (0.5, 1.0, 0.0), None if textured/connected
        :rtype: list(float)
        """
    ...
    def emissionWeight(self):
        ...
        :return: Emission weight value, 1.0 and above, None if textured/connected
        :rtype: float
        """
