...
from cgrig.libs.maya.cmds.animation import animobjects, grapheditorfcurve, animconstants, animlayers
...
class ScaleKeysCenter(object):
    ...
    def __init__(self, scaleAmount=1.0, animCurves=list(), scaleCacheDict=dict(), mode=AVERAGE_MODES[0]):
        ...
        Code Example:
            ...
            from cgrig.libs.maya.cmds.animation.scaleretime import ScaleKeysCenter
