...
from cgrig.libs.maya.cmds.objutils import scaleutils
...
from cgrig.libs.maya.cmds.objutils import namehandling, shapenodes, matching
...
def getBoundingBoxNoChildren(obj, worldSpace=True):
    ...
    if worldSpace:  # temp create a transform to measure the world space scale of the obj
        ...
        tempNode = cmds.group(empty=True, name="{}_tempCgRigXX".format(obj))
