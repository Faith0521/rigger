...
CAM_ATTRS = ["RmAspect", "RmRoundness", "RmDensity", "RmBladeCount", "RmBladeAngle"]


class CgRigFocusPullerRenderman(metafocuspuller.CgRigFocusPuller):
    """
    """
    ...
    def buildRig(self, camera_name):
        ...
        :rtype:
        """
        super(CgRigFocusPullerRenderman, self).buildRig(camera_name)
...
def buildRigSetup(camera_name):
    ...
    meta = CgRigFocusPullerRenderman()
