# -*- coding: utf-8 -*-
"""
from cgrig.libs.maya.cmds.shaders import shaderhsv
hsvInstance = shaderhsv.ShaderHSV()
"""
from maya import cmds

from cgrig.libs.maya.cmds.shaders import shaderutils, shadermulti, shdmultconstants as sc
from cgrig.libs.utils import color
from cgrig.libs.maya.utils import mayacolors


class ShaderHSV(object):
    """Class for managing diffuse color hsv offsets from cgrig shader instances.
    """
