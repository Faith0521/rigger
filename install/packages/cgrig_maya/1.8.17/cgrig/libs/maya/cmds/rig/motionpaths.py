...
from cgrig.libs.maya.cmds.objutils import namehandling, filtertypes, attributes, shapenodes
...
def createMotionPathRig(obj, curve, group=True, controlObj="", attrName=MOPATH_PATH_ATTR, followAxis="z", upAxis="y",
                        ...
                        sideTwist=True, parentConstrain=False, maintainOffset=False, follow=True, default=0.0):
    ...
    if not cmds.attributeQuery(attrName, node=controlObj, exists=True):
        ...
        cmds.setAttr("{}.{}".format(controlObj, attrName), default)
