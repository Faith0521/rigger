...
class AdditiveFk(object):
    ...
    Note: Best to build additive fk with the metaNode, see cgrig.libs.maya.cmds.meta.metaadditivefk

    Example:

        from cgrig.libs.maya.cmds.meta import metaadditivefk
        jointList = ["joint1", "joint2", "joint3", "joint4"]
        additiveFkInstance = metaadditivefk.CgRigMetaAdditiveFk()
    ...
    def _buildJointChains(self):
        ...
        """
        self.addFkJntList = cmds.duplicate(self.jointList, renameChildren=True, name="cgrig_temp_addFKJ")
        ...
        self.addFkBlendJntList = cmds.duplicate(self.addFkJntList, renameChildren=True, name="cgrig_temp_blendJ")
