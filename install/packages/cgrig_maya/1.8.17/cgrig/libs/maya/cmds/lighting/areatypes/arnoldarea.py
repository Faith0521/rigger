# -*- coding: utf-8 -*-
"""This module is the Arnold class for area lights
...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.lighting.areatypes import arnoldarea
    areaInst = arnoldarea.ArnoldArea("areaLightName", create=True, suffixName=False)  # creates a new area light
    ...
    areaInst = arnoldarea.ArnoldArea(name="existingAreaLight", create=False, ingest=True)  # ingest existing light
...
class ArnoldArea(areabase.AreaBase):
    ...
    def __init__(self, name="", genAttrDict=None, node=None, create=False, ingest=False, suffixName=False,
        ...
        :type message: bool
        """
        super(ArnoldArea, self).__init__(name=name,
