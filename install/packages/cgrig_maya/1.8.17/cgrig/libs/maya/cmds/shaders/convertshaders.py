...
New style shader code uses cgrig's shader instances.

from cgrig.libs.maya.cmds.shaders import convertshaders
...
from cgrig.libs.maya.cmds.shaders import shdmultconstants as shdm
from cgrig.libs.maya.cmds.shaders import shaderutils, shadermulti
from cgrig.libs.maya.cmds.renderer.rendererconstants import RENDERER_PLUGIN
from cgrig.libs.maya.cmds.shaders.shdmultconstants import SHADERTYPE_SUFFIX_DICT, RENDERER_SHADERS_DICT, MAYA
...
def convertShader(shaderName, convertToShaderType="standardSurface", reassign=True, removeShaders=False,
    ...
    :param message: Report a message to the user?
    :type message: bool
    :return shaderInstance: A cgrig shader instance of the newly created shader
...
def convertShaderList(shaderList, convertToShaderType="standardSurface", reassign=True, removeShaders=False,
    ...
    :param message: Report a message to the user?
    :type message: bool
    :return shaderInstances: A list of cgrig shader instance of the newly created shader
...
def swatchColorsToNewRenderSpace(shaderName, originalRenderSpace="scene-linear Rec.709-sRGB", message=True):
    ...
    Affects supported cgrig shaders only.
