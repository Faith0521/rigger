...
if __name__ == "__main__":
    ...
    OPEN_PATH = r"C:\Users\Andrew Silke\Documents\cgrig_preferences\assets\maya_scenes\cgrig_rigs_hive\natalie_rig_STRD\natalie_rig_STRD.ma"
    SHADER_TYPES = ["blinn"]
    REMOVE_SHADERS = "1"
    ...
    # Script path ----------------
    scriptPath = r'D:\repos\cgrigtools_dev\cgrig_maya\cgrig\libs\maya\cmds\shaders\standalone\convertshaderscene.py'

    # Environment Variables ------------------------------------------------
    envCopy = os.environ.copy()
    envCopy["MAYA_APP_DIR"] = r"D:\repos\mayaPrefs\cgrig_v2"
    envCopy["MAYA_MODULE_PATH"] = r"D:\repos\cgrigtools_pro\modules"
