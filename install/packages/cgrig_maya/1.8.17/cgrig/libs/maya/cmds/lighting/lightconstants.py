...
from cgrig.libs.maya.cmds.renderer.rendererconstants import RENDERER_SUFFIX, RENDERER_ICONS_LIST, RENDERER_ICONS_DICT
from cgrig.libs.maya.cmds.assets import assetsconstants
...
DIRECTIONAL_TRACKER_ATTR = "cgrigRendererTracker"
