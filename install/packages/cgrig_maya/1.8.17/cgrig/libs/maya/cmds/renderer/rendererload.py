...
from cgrig.libs.maya.cmds.renderer.rendererconstants import REDSHIFT, RENDERMAN, ARNOLD, RENDERER_PLUGIN, MAYA, VRAY
from cgrig.libs.maya.cmds.renderer import arnoldrendersettings, redshiftrendersettings, rendermanrendersettings

from cgrig.preferences.interfaces import coreinterfaces


def currentCgRigRenderer():
    """Returns primary renderer that CgRig Tools has set in its preferences.
...
def loadRenderer(renderer, setCgRigDefaults=True):
    ...
    if renderer == ARNOLD:
        success = arnoldrendersettings.loadRendererArnold(setCgRigDefaults=setCgRigDefaults)
    elif renderer == REDSHIFT:
        success = redshiftrendersettings.loadRendererRedshift(setCgRigDefaults=setCgRigDefaults)
    elif renderer == RENDERMAN:
        success = rendermanrendersettings.loadRendererRenderman(setCgRigDefaults=setCgRigDefaults)
    elif renderer == VRAY:
