...
CAM_ATTRS = ["ArAperture", "ArAspect", "ArBladeCount", "ArBladeAngle", "ArBladeRotation"]


class CgRigFocusPullerArnold(metafocuspuller.CgRigFocusPuller):
    """
    """
    ...
    def proxyAttribute(self):
        ...
        attributes.addProxyAttribute(camera_name, camera_shape, "aiApertureSize", proxyAttr="ArAperture",
                                     channelBox=True)
    ...
    def buildRig(self, camera_name):
        ...
        :rtype:
        """
        super(CgRigFocusPullerArnold, self).buildRig(camera_name)
...
def buildRigSetup(camera_name):
    ...
    # camera is clean so build
    meta = CgRigFocusPullerArnold()
