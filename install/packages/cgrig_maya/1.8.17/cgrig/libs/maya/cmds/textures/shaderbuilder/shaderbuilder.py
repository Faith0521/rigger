...
from cgrig.libs.maya.cmds.textures.shaderbuilder import shaderbuilder
shaderbuilder.buildShaderAndTextures(shaderType="standardSurface", files=FILES)

# build many shaders from sub directories.
from cgrig.libs.maya.cmds.textures.shaderbuilder import shaderbuilder
directory = "C:/Users/userName/Documents/cgrig_preferences/assets/maya_shaders/polyHaven"
...
from cgrig.libs.maya.cmds.shaders import shadermulti, shdmultconstants
from cgrig.libs.maya.cmds.textures.filetexturetypes import mayafiletexture
from cgrig.libs.maya.cmds.textures.normaltypes import normalmaya

IMAGE_EXTS = (".jpg", ".jpeg", ".png", ".tif", ".tiff", ".bmp", ".tga", ".exr")

DIRECTORY = r"C:\Users\Andrew Silke\Documents\cgrig_preferences\assets\maya_shaders\polyHaven\cleanPebbles_STRD"
