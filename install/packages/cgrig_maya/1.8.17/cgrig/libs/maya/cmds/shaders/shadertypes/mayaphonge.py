...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.shaders.shadertypes import mayaphonge
...
SPECULAR_ROUGHNESS_ATTR = "roughness"
SPECULAR_IOR_ATTR = ""
COAT_WEIGHT_ATTR = ""
COAT_COLOR_ATTR = ""
COAT_ROUGHNESS_ATTR = ""
...
class PhongE(shaderbase.ShaderBase):
    ...
    def __init__(self, shaderName="", node=None, genAttrDict=None, create=False, ingest=False, suffixName=False,
        ...
        :type message: bool
        """
        super(PhongE, self).__init__(shaderName=shaderName,
                                     node=node,
    ...
    def createShader(self, message=True):
        ...
        :type message: bool
        """
        shaderName = cmds.shadingNode('phongE', asShader=True, name=self.shaderNameVal)
    ...
    def specRoughness(self):
        ...
        PhongE this value is inverted and falls in a range of 2.0 - 100, 100 is sharp, 2.0 is rough
        So this function does the math to convert into a 0.0-1.0 range
