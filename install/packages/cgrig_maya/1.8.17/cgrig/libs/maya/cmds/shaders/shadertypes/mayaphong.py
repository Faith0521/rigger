...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.shaders.shadertypes import mayaphong
...
SPECULAR_ROUGHNESS_ATTR = "cosinePower"
SPECULAR_IOR_ATTR = ""
COAT_WEIGHT_ATTR = ""
COAT_COLOR_ATTR = ""
COAT_ROUGHNESS_ATTR = ""
...
class Phong(shaderbase.ShaderBase):
    ...
    def __init__(self, shaderName="", node=None, genAttrDict=None, create=False, ingest=False, suffixName=False,
        ...
        :type message: bool
        """
        super(Phong, self).__init__(shaderName=shaderName,
                                    node=node,
    ...
    def createShader(self, message=True):
        ...
        :type message: bool
        """
        shaderName = cmds.shadingNode('phong', asShader=True, name=self.shaderNameVal)
