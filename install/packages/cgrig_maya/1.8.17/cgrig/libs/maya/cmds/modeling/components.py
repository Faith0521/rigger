...
from cgrig.libs.maya.cmds.modeling import components
components.trisFromSelection(select=True, message=True)

"""
import maya.cmds as cmds
from cgrig.libs.utils import output
from cgrig.libs.maya.cmds.objutils import filtertypes, selection
...
def softEdgeList(obj, time=False):
    ...
    NOTE: Unused as is too slow, now using cgrig.libs.buliarcacristian.lockNormals_toHS
