...
class StandardSurface(shaderbase.ShaderBase):
    ...
    def setFromDict(self, genAttrDict, apply=True, noneIsDefault=True, colorsAreSrgb=False):
        ...
        Fix Clear Coat issues where standardSurface can apply as grey color, should always be white 100% bright
        ...
        super(StandardSurface, self).setFromDict(genAttrDict,
                                                 apply=apply,
    ...
    def createShader(self, message=True):
        ...
        :type message: bool
        """
        shaderName = cmds.shadingNode('standardSurface', asShader=True, name=self.shaderNameVal)
