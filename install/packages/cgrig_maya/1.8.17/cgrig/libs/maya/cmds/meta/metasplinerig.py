...
class MetaSplineRig(base.MetaBase):
    ...
    def allMessageNodes(self, includeDefault=False):
        ...
        messageAttrs = [m['name'] for m in metaAttrs if m['Type'] == zapi.attrtypes.kMFnMessageAttribute and (
                "cgrigMMeta" not in m['name'] and includeDefault is False)]
    ...
    def deleteAdditiveFkRig(self):
        ...
        :rtype:
        """
        executor.execute("cgrig.maya.additiveFk.delete", meta=self.additiveFkMetaNode())
    ...
    def setAdditiveFk(self, additiveFkMeta, mod=None):
        ...
        :type additiveFkMeta: :class:`metaadditivefk.CgRigMetaAdditiveFk`
        :return:
        :rtype:
        """
    ...
    def additiveFkMetaNode(self):
        ...
        :return: Returns the meta node of the additive cgrig meta
        :rtype: :class:`metaadditivefk.CgRigMetaAdditiveFk`
        """
        dag = self.additiveFkMeta.value()
        if dag:
            return metaadditivefk.CgRigMetaAdditiveFk(node=dag.object())
    ...
    def _setupAdditiveFk(self, mod):
        ...
        :return:
        """
        additiveFkMeta = metaadditivefk.CgRigMetaAdditiveFk.connectedMetaNodes(self.startJointNode())
