...
from cgrig.libs.maya.cmds.objutils import attributes, namehandling, objhandling, namewildcards
from cgrig.libs.maya.cmds.renderer.rendererconstants import RENDERMAN, REDSHIFT, ARNOLD, RENDERER_SUFFIX, \
    DEFAULT_MAYA_SHADER_TYPES
from cgrig.libs.maya.cmds.shaders.shdmultconstants import SHADER_TYPE_LIST
from cgrig.libs.maya.cmds.shaders import arnoldshaders, redshiftshaders, rendermanshaders, redshiftaovs, rendermanaovs, \
