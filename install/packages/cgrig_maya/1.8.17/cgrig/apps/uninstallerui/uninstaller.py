# -*- coding: utf-8 -*-
from cgrig.apps.uninstallerui import core
from cgrig.libs.maya.qt import mayaui
from cgrig.libs.pyqt.widgets import elements
from cgrigvendor.Qt import QtWidgets


class UninstallerUi(elements.CgRigWindow):
    windowSettingsPath = "cgrig/uninstallerui"
    ...
    def _initUi(self):
        ...
        self.titleLabel = elements.HeaderLabel(text="Uninstall CgRig Tools Pro",
                                               parent=self)

        self.mainLayout.addWidget(self.titleLabel)
        self.mainLayout.addWidget(
            QtWidgets.QLabel("Thank you for using CgRig Tools Pro. You may re-install at any time."))
        self.mainLayout.addSpacing(15)
        self.cgrigtoolsChkBox = elements.LabelDividerCheckBox(text="CgRig Tools Pro", checked=True)
        checkboxLayout.addWidget(self.cgrigtoolsChkBox)
    ...
    def uninstall(self):
        ...
        mayaWindow = mayaui.mayaWindow()
        cgrigtools = self.cgrigtoolsChkBox.checkbox.isChecked()
        ...
        uninstalled = self.core.uninstall(cgrigtools, assets, prefs, cache)
        if uninstalled:
            flags = QtWidgets.QMessageBox.StandardButton.Ok

            QtWidgets.QMessageBox.information(mayaWindow,
                                              "Uninstalled CgRigToolsPro",
                                              "The selected components of CgRig Tools Pro have been uninstalled.",
                                              flags)
