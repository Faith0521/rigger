# -*- coding: utf-8 -*-
import cgrig.libs.toolsets.controls
from maya import cmds
from cgrig.libs.toolsets.controls.controlscore import ControlsCore
from cgrig.libs.maya.cmds.objutils import shapenodes, filtertypes, objcolor, namehandling
...
class ControlsCoreMaya(ControlsCore):
    ...
    def __init__(self, toolsetWidget):
        ...
        :param toolsetWidget:
        :type: cgrig.apps.uitoolsets.controlcreator.ControlCreator
        """
