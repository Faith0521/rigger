...
class CgRigRenamer(toolsetwidget.ToolsetWidget):
    id = "cgrigRenamer"
    uiData = {"label": "CgRig Renamer",
              "icon": "cgrigRenamer",
              "tooltip": "Tools For Renaming Objects",
              "defaultActionDoubleClick": False,
              "helpUrl": "https://create3dcharacters.com/maya-tool-cgrig-renamer/"
              }
    ...
    def currentWidget(self):
        ...
        """
        return super(CgRigRenamer, self).currentWidget()
    ...
    def widgets(self):
        ...
        """
        return super(CgRigRenamer, self).widgets()
    ...
    def connectionsRenamer(self):
        """Connects up the buttons to the CgRig Renamer logic """
        # both GUIs
...
class RenamerWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        # grpRadioNameList = ["Up", "Dn"]
        # grpRadioToolTipList = ["Create groups upward based on the selected objects.",
        #                        "Create groups downward  based on the selected objects."]
        # self.grpOptionsRadio = elements.RadioButtonGroup(radioList=grpRadioNameList, toolTipList=grpRadioToolTipList,
        #                                                  default=0, parent=parent)
...
class RenamerAdvancedWidget(RenamerWidgets):
    def __init__(self, parent=None, properties=None, uiMode=UI_MODE_ADVANCED, toolsetWidget=None):
        ...
        # Bottom Button Layout 3 ------------------------------------
        # bottomBtnLayout3 = elements.hBoxLayout(spacing=0)
        # bottomBtnLayout3.addWidget(self.grpOptionsRadio)
        # Add to main Layout ------------------------------------
