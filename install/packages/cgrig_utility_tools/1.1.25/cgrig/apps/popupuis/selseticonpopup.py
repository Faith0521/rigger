...
class SelSetsIconPopup(elements.CgRigWindowThin):
    ...
    def createSelSet(self):
        ...
        selectionsets.createSelectionSetCgRigSel(self.setName.text(),
                                               icon=iconText,
    ...
    def widgets(self):
        ...
        toolTip = "Sets the visibility of the Selection Set in the CgRig \n" \
        ...
        # Set MM Priority -----------------
        toolTip = "The priority level of the set for cycling in the CgRig Marking Menu. \n" \
        ...
        toolTip = "Create a `Selection Set` or an `Object Set`. \n" \
                  "Note: Object Sets are not seen in the CgRig Selection \n" \
