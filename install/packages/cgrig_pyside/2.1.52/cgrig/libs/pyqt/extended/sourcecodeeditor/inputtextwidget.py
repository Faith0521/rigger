...
from cgrig.libs.pyqt.widgets import textedit
...
class TextEditor(QtWidgets.QPlainTextEdit):
    ...
    def commentLine(self, indent, cursor, comment, newLine=True):
        ...
        cursor.movePosition(QtGui.QTextCursor.Right, QtGui.QTextCursor.MoveAnchor, indent)
        if comment:
            cursor.insertText("# ")
    ...
    def wheelEvent(self, event):
        """
        Handles cgrigm in/out of the text.
        """
    ...
    def cgrigm(self, direction):
        """
        CgRigm in on the text.
        """
