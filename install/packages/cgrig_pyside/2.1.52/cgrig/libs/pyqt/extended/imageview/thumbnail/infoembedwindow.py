# -*- coding: utf-8 -*-
from cgrig.libs.pyqt.extended.combobox import ComboBoxSearchable
from cgrig.libs.pyqt.extended.embeddedwindow import EmbeddedWindow
from cgrig.libs.pyqt.extended.lineedit import LineEdit
from cgrig.libs.pyqt.widgets.buttons import styledButton
from cgrig.libs.pyqt.widgets.label import Label
from cgrig.libs.pyqt.widgets.layouts import hBoxLayout, GridLayout, vBoxLayout
from cgrig.libs.pyqt.widgets.textedit import TextEdit
from cgrig.libs.utils import path, output
...
from cgrig.libs.pyqt.extended.imageview import items, model

from cgrig.libs.cgrigscene.constants import ASSETTYPES
...
class ExtensionLabel(Label):
    def setText(self, text):
        ...
        self.setFixedWidth(fm.horizontalAdvance(text))
...
class InfoEmbedWindow(EmbeddedWindow):
    ...
    def miniBrowser(self):
        ...
        :return:
        :rtype: cgrig.libs.pyqt.extended.imageview.thumbnail.minibrowser.MiniBrowser
        """
    ...
    def miniBrowser(self, value):
        ...
        :param value:
        :type value: cgrig.libs.pyqt.extended.imageview.thumbnail.minibrowser.MiniBrowser
        :return:
        :rtype:
        """
    ...
    def rename(self):
        """ Rename the cgrig file and its dependencies
        """
        # Empty Text
        ...
        if self.metadata['name'] != self.nameEdit.text():
            self.saveMetaData()
            scenePath = self.metadata['cgrigFilePath']
            ext = self.metadata['extension']
            newName = self.nameEdit.text()

            renamedFiles, depDir = cgrigscenefiles.renameCgRigSceneOnDisk(newName, scenePath, ext)
    ...
    def saveMetaData(self, event=None):
        ...
        """
        cgrigscenefiles.writeCgRigInfo(self.metadata['cgrigFilePath'], self.typeCombo.currentText(),
        ...
        self.metadata['extension'] = path.getExtension(self.metadata['cgrigFilePath'])
