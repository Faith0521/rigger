...
from cgrig.libs.pyqt.widgets import listview
...
class ThumbnailWidget(listview.ListView):
    ...
    def wheelEvent(self, event):
        ...
        if not self.cgrigmable or modifiers != QtCore.Qt.ControlModifier:
    ...
    def filter(self, text, tag=None):
        ...
        self.proxyFilterModel.setFilterRegularExpression(QtCore.QRegularExpression(text,
    ...
    def _setCgRigmAmount(self, value):
        """ Sets the cgrigm amount to this view by taking the view iconSize()*value
