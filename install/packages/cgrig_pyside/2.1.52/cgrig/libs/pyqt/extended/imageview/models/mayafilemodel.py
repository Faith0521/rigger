...
from cgrig.libs.pyqt.extended.imageview.models.suffixfiltermodel import SuffixFilterModel
...
class MayaFileModel(SuffixFilterModel):
    ...
    def __init__(self, view, directories=None, chunkCount=0, uniformIcons=False, assetPreference=None):
        ...
        This class can be overridden further for custom image loading in subdirectories such as .cgrigScene files.
    ...
    def updateItems(self):
        ...
        for f in self.fileItems:
            dep = cgrigscenefiles.getDependencyFolder(f.fullPath(), create=False)[0]
