...
class EmbeddedWindow(QtWidgets.QFrame):
    ...
    def __init__(self, parent=None, title="", defaultVisibility=False, uppercase=False, closeButton=None,
        ...
        A button is passed in as an optional close button because it'll probably be using the cgrig package cgrig_core_pro
    ...
    def initUi(self):
        ...
        if self.hidePropertiesBtn or self.title:
            ...
            if self.hidePropertiesBtn:  # close button passed in as uses cgrig_core_pro
