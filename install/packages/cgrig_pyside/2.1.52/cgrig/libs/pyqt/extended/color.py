...
from cgrig.libs.pyqt import utils, keyboardmouse
from cgrig.libs.pyqt.extended import menu, colorpopup
from cgrig.libs.pyqt.widgets import layouts, label, slider, stringedit, buttons
...
class ColorBtn(QtWidgets.QWidget, menu.MenuCreateClickMethods):
    ...
    def _updateColor(self):
        """Updates the color on the color picker widget, usually Maya will perform this auto but CgRig stylesheeting
...
class ColorButton(QtWidgets.QLabel):
    ...
    def pickerColorChanged(self, colorEvent):
        ...
        :param colorEvent:
        :type colorEvent: :class:`cgrig.libs.pyqt.extended.colors.colorpopup.PickerColors`
        :return:
        """
...
class ColorSlider(QtWidgets.QWidget):
    ...
    def _sliderUpdated(self):
        ...
        value = self.slider.value()  # is a float because cgrig Slider
