# -*- coding: utf-8 -*-
from cgrig.libs.pyqt.widgets.pathwidget import BrowserPathListWidget
...
class MiniBrowserPathList(BrowserPathListWidget):
    def __init__(self, assetPref, parent=None, toolTip=None):
        ...
        :param toolTip:
        """
        defaultPath = assetPref.cgrigPrefsDefaultsPath()
    ...
    def directoryAddPath(self, w):
        ...
        :param w:
        :type w: :class:`cgrig.libs.pyqt.widgets.pathwidget.BrowserPathWidget`
        :return:
        """
    ...
    def directoryAliasChanged(self, pathWidget, alias):
        ...
        :param pathWidget:
        :type pathWidget: cgrig.libs.pyqt.widgets.pathwidget.BrowserPathWidget
        :param alias:
        :return:
        """
