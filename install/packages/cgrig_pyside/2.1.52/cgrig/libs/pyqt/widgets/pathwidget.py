...
from cgrig.libs.pyqt.widgets import popups
...
from cgrig.libs.pyqt.widgets.stringedit import StringEdit
from cgrig.libs.pyqt.widgets.iconmenu import DotsMenu
from cgrig.libs.pyqt.widgets.layouts import (hBoxLayout,
                                           vBoxLayout)

from cgrig.libs.pyqt import uiconstants, utils

from cgrig.libs.utils import filesystem, output, path as zpath
...
class PathWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, path=None, alias=None, aliasActive=False, toolTip=None, label=None):
...
class DirectoryPathWidget(PathWidget):
    ...
    def __init__(self, parent=None, path=None, alias=None, aliasActive=False, label=None, toolTip=None):
        super(DirectoryPathWidget, self).__init__(parent, path, alias, aliasActive, label=label, toolTip=None)
...
class BrowserPathListWidget(DirectoryPathListWidget):
    ...
    def addByDirectoryPath(self, directoryPath):
        ...
        :param directoryPath:
        :type directoryPath: :class:`cgrig.core.tooldata.tooldata.DirectoryPath`
        :return:
        """
...
class BrowserPathWidget(DirectoryPathRemoveWidget):
    ...
    def data(self):
        ...
        :return:
        :rtype: :class:`cgrig.core.tooldata.tooldata.DirectoryPath`
        """
        return self._data
