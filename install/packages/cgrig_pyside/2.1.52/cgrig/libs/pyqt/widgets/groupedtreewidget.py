...
from cgrig.libs.pyqt.widgets import expandedtooltip, layouts
from cgrig.libs.pyqt.widgets import stackwidget
from cgrig.libs.pyqt.widgets import frame
...
class GroupedTreeWidget(QtWidgets.QTreeWidget):
    ...
    def insertGroup(self, name="", index=0, treeParent=None, expanded=True, groupWgt=None, icon=None):
        ...
        :param expanded:
        :param groupWgt:
        :type groupWgt: cgrig.apps.hiveartistui.views.componentwidget.ComponentGroupWidget
        :param icon:
        :return:
        """
        if self.locked:
