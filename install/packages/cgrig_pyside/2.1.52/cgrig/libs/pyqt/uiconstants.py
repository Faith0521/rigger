...
CGRIG_BTN_PADDING = 7, 4, 4, 4
NO_ICON_BTN_PADDING = 8, 8, 4, 7
CGRIG_BTN_ICON_SIZE = 16
...
# Button Styles
BTN_DEFAULT = 0  # Default cgrig extended button with optional text or an icon.
BTN_TRANSPARENT_BG = 1  # Default cgrig extended button w transparent bg.
BTN_ICON_SHADOW = 2  # Main cgrig IconPushButton button (icon in a colored box) with shadow underline
BTN_DEFAULT_QT = 3   # Default style uses vanilla QPushButton and not cgrig's extended button
