...
.. code-block:: python
    ...
    from cgrig.libs.maya.cmds.animation import tweenmachine
...
from cgrig.libs.maya.cmds.animation import animobjects
...
class TweenMachine(object):
    ...
    def getCurves(self):
        ...
        animCurves = cmds.keyframe(q=True, name=True, selected=True)
        if animCurves:
        ...
        # If attributes are selected in channel box, use them to build curve node list
