...
from cgrig.apps.model_assets import assetdirectories


class CgRigModelAssetsPrefsWidget(prefmodel.SettingWidget):
    ...
    def __init__(self, parent=None, setting=None):
        ...
        """
        super(CgRigModelAssetsPrefsWidget, self).__init__(parent, setting)
