...
class AssetIconShelf(palette.ActionPlugin):
    id = "cgrig.shelf.assets"
    ...
    def execute(self, *args, **kwargs):
        ...
        if name == "cgrig_build_scene_camera":
        ...
        if name == "cgrig_build_macbeth_balls":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     ...
                                                     message=True)
        elif name == "cgrig_build_scene_studio_rim":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     ...
                                                     replaceByType=True,
                                                     message=True)
        elif name == "cgrig_build_scene_studio_three_point":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     ...
                                                     darkShader=False,
                                                     message=True)
        elif name == "cgrig_build_scene_studio_three_point_drk":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     ...
                                                     darkShader=False,
                                                     message=True)
        elif name == "cgrig_build_scene_studio_soft_top":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     ...
                                                     darkShader=False,
                                                     message=True)
        elif name == "cgrig_build_scene_studio_red_aqua_rim":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     ...
                                                     replaceByType=True,
                                                     message=True)
        elif name == "cgrig_build_scene_skydome_factory_grey":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     ...
                                                     darkShader=False,
                                                     message=True)
        elif name == "cgrig_build_scene_skydome_factory_color":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
                                                     lightPresetPath=defaultassets.DEFAULT_LIGHT_PRESET_PATH,
                                                     ...
                                                     darkShader=False,
                                                     message=True)
        elif name == "cgrig_build_scene_skydome_winter":
            defaultassets.buildDefaultAssetsSceneCyc(renderer=renderer,
                                                     assetDirPath=defaultassets.MODEL_ASSETS_PATH,
                                                     assetCgRigScene=defaultassets.ASSET_CYC_GREY_SCENE,
