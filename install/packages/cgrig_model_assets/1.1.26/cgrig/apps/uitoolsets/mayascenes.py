...
from cgrig.apps.toolsetsui.widgets.toolsetwidget import ToolsetWidget
from cgrigvendor.Qt import QtWidgets, QtCore

from cgrig.libs.utils import output
from cgrig.apps.model_assets import mayascenescore
...
from cgrig.libs.maya.cmds.renderer.rendererconstants import RENDERER_ICONS_LIST_ALL
...
from cgrig.preferences.interfaces import coreinterfaces, assetinterfaces

from cgrig.libs.pyqt.extended.imageview.models import mayafilemodel
...
class MayaScenes(ToolsetWidget, RendererMixin, MiniBrowserMixin):
    ...
    def browserSelectionChanged(self, image, item):
        ...
        :type image:
        :param item:
        :type item: cgrig.libs.pyqt.extended.imageview.items.BaseItem
        :return:
        :rtype:
        """
    ...
    def actionTriggered(self, action, mouseMenu):
        ...
        :param action:
        :type action: :class:`cgrig.libs.pyqt.extended.searchablemenu.action.TaggedAction`
        """
    ...
    def deleteScenePopup(self, shapeName):
        ...
        :type shapeName: cgrig.libs.pyqt.extended.imageview.items.BaseItem
        :return okState: Ok button was pressed
        :rtype okState: bool
        """
        message = "Are you sure you want to delete '{0}' from the CgRig Scene Library?\n" \
...
class AllWidgets(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None, core=None):
        ...
        :param core: directory path of the light preset cgrigScene files
        :type core: `cgrig.apps.model_assets.mayascenescore.MayaScenesCore`
        """
