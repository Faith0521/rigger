...
grayscaleIcon = iconlib.Icon().grayscaleIcon
iconPath = iconlib.Icon().iconPath
grayscale = iconlib.Icon().grayscale
tint = iconlib.Icon().tint
addOverlay = iconlib.Icon().addOverlay
colorPixmap = iconlib.Icon().colorPixmap
