...
from cgrig.core.util import zlogging, classtypes
...
class Icon(object):
    """This class acts as a uniform interface to manipulate, create, retrieve Qt icons from the cgrig library.
    """
    ...
    def reload(cls):
        ...
        # find and store all the found icons with the base cgrig paths
        cls.iconPaths = os.getenv("CGRIG_ICON_PATHS", "").split(os.pathsep)
