...
if general.TYPE_CHECKING:
    from cgrig.apps.uitoolsets.controlcreator import ControlCreator
...
class ControlsCore(QtCore.QObject):
    ...
    def __init__(self, toolsetWidget):
        ...
        :param toolsetWidget:
        :type toolsetWidget: :class:`cgrig.apps.uitoolsets.controlcreator.ControlCreator`
        """
    ...
    def deleteShapeDesignFromDisk(self, designName, directory):
        ...
        return cgrigscenefiles.deleteCgRigSceneFiles(self.fullPath, message=True)
