...
class TweenMachine(toolsetwidget.ToolsetWidget):
    ...
    def tweenSliderPressed(self):
        """Start the tween"""
        self.openUndoChunk(name="cgrigTweenMachine")
    ...
    def tweenSliderReleased(self):
        ...
        self.closeUndoChunk(name="cgrigTweenMachine")

    def tweenTextChanged(self, blank):
        if self.countr == 1:  # hack as is triggering twice, second time is correct
            self.openUndoChunk(name="cgrigTweenMachine")
            ...
            self.countr = 0  # Hack as is triggering twice, will trigger on second go.
            self.closeUndoChunk(name="cgrigTweenMachine")
        self.countr += 1  # add one as is 0 and first time round with incorrect value
