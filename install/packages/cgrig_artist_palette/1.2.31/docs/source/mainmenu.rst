...
Once you create a `.layout` file and you've defined a layout then in your cgrig_package.json file append
the below environment variable under the environment section.

.. code-block:: json

    },
    "CGRIG_MENU_LAYOUTS": ["tools/layouts/mytools_menu_layout.layout"]
    }
