# -*- coding: utf-8 -*-
""" ---------- CgRig Icons -------------
CgRig Icon Library UI for developers, click the icons name copied to the clipboard
...
from cgrig.libs.pyqt.models import datasources, listmodel, constants, modelutils
...
class CgRigIcons(toolsetwidget.ToolsetWidget):
    id = "cgrigIcons"
    info = "Icon library for CgRig Tools Pro"
    uiData = {"label": "CgRig Icon Library",
              "icon": "image",
              "tooltip": "Icon library for CgRig Tools Pro",
    ...
    def currentWidget(self):
        ...
        :rtype: list[:class:``]
        """
        return super(CgRigIcons, self).currentWidget()
    ...
    def widgets(self):
        ...
        :rtype: list[:class:``]
        """
        return super(CgRigIcons, self).widgets()
