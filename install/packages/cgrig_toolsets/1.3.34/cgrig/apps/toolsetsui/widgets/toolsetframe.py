...
from cgrig.apps.toolsetsui.widgets import toolsettoolbar, toolsettree
from cgrig.apps.toolsetsui.widgets import toolsetwidgetitem
from cgrig.apps.toolsetsui.widgets.menubutton import ToolsetMenuButton
...
class ToolsetFrame(QtWidgets.QFrame):
    ...
    (:class:`cgrig.apps.toolsetsui.widgets.toolsettoolbar.ToolsetToolBar`)

    which is moved to the frameless window header area later
    (:class:`cgrig.apps.toolsetsui.widgets.frameless.TitleBar`),
    ...
    def __init__(self, parent, toolsetRegistry, window, iconColor=(255, 255, 255), 
        ...
        :type window: :class:`cgrig.apps.toolsetsui.toolsetui.ToolsetsUI`
        :type parent:
        :param toolsetRegistry:
        :type toolsetRegistry: :class:`cgrig.apps.toolsetsui.registry.ToolsetRegistry`
    ...
    def toolsetById(self, toolsetId):
        ...
        :type toolsetId:
        :return:
        :rtype: cgrig.apps.toolsetsui.widgets.toolsetwidget.ToolsetWidget
        """
        if self.tree:
