...
from cgrig.libs.pyqt.widgets import stackwidget
from cgrig.libs.utils import color
from cgrig.core.util import zlogging
from cgrig.apps.toolsetsui.widgets import toolsettree
from cgrig.libs.pyqt.extended.imageview.thumbnail.minibrowser import MiniBrowserThumbnail
    ...
    def setActive(self, active=True, emit=True):
        ...
        if active:
            ...
            utils.singleShotTimer(
                lambda: self.toolsetHidden.emit())  # todo if toolset hidden is the correct signal to use here
