...
from cgrig.apps.toolsetsui.widgets import toolsetwidgetitem
from cgrig.core.util import zlogging
from cgrig.libs.pyqt import utils
from cgrig.libs.pyqt.widgets import groupedtreewidget
from cgrig.libs.utils import general

logger = zlogging.getLogger(__name__)

if general.TYPE_CHECKING:
    from cgrig.apps.toolsetsui.widgets.toolsetframe import ToolsetFrame
...
class ToolsetTreeWidget(groupedtreewidget.GroupedTreeWidget):
    ...
    def __init__(self, parent=None, registry=None):
        ...
        :param parent: 
        :type parent: cgrig.apps.toolsetsui.widgets.toolsetframe.ToolsetFrame
        :param registry: 
        :type registry:
        """
    ...
    def iterator(self):
        ...
        :return:
        :rtype: collections.Iterator[cgrig.apps.toolsetsui.widgets.toolsetwidgetitem.ToolsetWidgetItem]
        """
    ...
    def toolsets(self):
        ...
        :return:
        :rtype: list of cgrig.apps.toolsetsui.widgets.toolsetwidget.ToolsetWidget
        """
    ...
    def spawnToolset(self, pos):
        ...
        window = CgRigWindow.getCgRigWindow(self)
        pos = pos.x() - window.width() / 2, pos.y() + 30
        sourceItem = self._toolsetFrame.toggleToolset(toolsetId)  # toolset not working?
        _, toolsetUI = _cgrigPalette.executePluginById("cgrig.toolsets", toolsetIds=[toolsetId], position=pos)
    ...
    def itemsVisible(self):
        ...
        :return:
        :rtype: list[:class:`cgrig.apps.toolsetsui.widgets.toolsetwidgetitem.ToolsetWidgetItem`]
        """
    ...
    def activeItems(self):
        ...
        :return:
        :rtype: list[tuple(cgrig.apps.toolsetsui.widgets.toolsetwidgetitem.ToolsetWidgetItem, int)]
        """
        ret = []
        for it in self.iterator():
            treeItem = it
