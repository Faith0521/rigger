...
from cgrig.libs.pyqt.widgets import flowlayout
from cgrig.libs.pyqt.widgets import elements
from cgrig.libs.pyqt.widgets import extendedbutton


class ToolsetIconPopup(elements.CgRigWindow):
    ...
    :type toolsetRegistry:  cgrig.apps.toolsetsui.registry.ToolsetRegistry
    """
    ...
    def __init__(self, toolsetFrame, toolsetRegistry=None,
        ...
        super(ToolsetIconPopup, self).__init__(name=name + "menu", title=name,
                                               parent=engine.currentEngine().host.qtMainWindow,
                                               resizable=False,
    ...
    def _sizeHint(self):
        ...
        .. note::
            Because this is a cgrigWindow the size has to be set on the parentContainer, so we don't
