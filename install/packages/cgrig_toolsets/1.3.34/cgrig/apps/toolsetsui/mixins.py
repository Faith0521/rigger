...
if general.TYPE_CHECKING:
    ...
    from cgrig.libs.pyqt.extended.imageview.thumbnail.minibrowser import MiniBrowser
...
class MiniBrowserMixin(object):
    ...
    def setAssetPreferences(self, prefs):
        ...
        :param prefs:
        :type prefs: :cgrig.preferences.prefinterface.BrowserPreference:
        :return:
    ...
    def prefs(self):
        ...
        :return:
        :rtype: cgrig.preferences.assets.BrowserPreference
        """
