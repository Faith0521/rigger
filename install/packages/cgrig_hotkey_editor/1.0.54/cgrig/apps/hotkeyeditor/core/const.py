...
DEFAULT_KEYSET = "CgRig_Tools_Default"
DEFAULT_MAYA = "Maya_Default_CgRigMod"
DEFAULT_MAYA_NOCGRIG = "Maya_Default"
DEFAULT_TEMPLATE = "New_KeySet_Template"

KEYSET_PREFIX = "CgRig_User_"
KEYSETS = [DEFAULT_KEYSET, DEFAULT_MAYA]
USERPREF = cmds.internalVar(userPrefDir=1)
PREF_FOLDER_NAME = "cgrig_hotkey_editor"
...
DEFAULT_CATEGORY = "Custom Scripts.cgrigTools"

JSON_TRUE = "##TRUE##"

RTCOMBO_USERCMDS = "=== MAYA COMMANDS ==="
RTCOMBO_MAYACMDS = "=== USER COMMANDS ==="
RTCOMBO_CGRIGCMDS = "=== CGRIG COMMANDS ==="
