...
def hotkeyPathUserPrefs():
    ...
    Return Example:
        "C:/Users/username/Documents/cgrig_preferences/prefs/maya/cgrig_hotkey_editor"
...
def hotkeyPathInternalPrefs():
    """Returns the path of the cgrig tools internal hotkey path

    Return Example:
        "D:/somepath/cgrigtools_pro/packages/cgrig_hotkey_editor/preferences/prefs/maya"
...
def isAdminMode():
    ...
    Returns True if os.environ["CGRIG_ADMIN"] == "1"
    ...
    :return result: Returns True if the os.environ["CGRIG_ADMIN"] == "1" must be a string not "True" or 1
    :rtype result: bool
    """
