...
class JointsMarkingMenuCommand(menu.MarkingMenuCommand):
    ...
    .. code-block:: python
        ...
        cgrigMenu.MarkingMenu.buildFromLayout("markingMenu.joints",
                                            "markingMenuJoints",
    ...
    def execute(self, arguments):
        ...
        elif operation == "cgrigOrientJoint":
        ...
        elif operation == "cgrigCreateControls":
        ...
        elif operation == "cgrigRenamer":
            run.openToolset("cgrigRenamer")
