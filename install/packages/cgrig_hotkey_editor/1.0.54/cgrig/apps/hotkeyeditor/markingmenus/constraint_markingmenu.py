...
from cgrig.libs.maya.cmds.objutils import constraints, locators, matching
from cgrig.apps.toolsetsui import run
from cgrig.libs.maya.cmds.rig import riggingmisc

CONSTRAINTS_TRACKER_INST = constraints.CgRigConstraintsTrackerSingleton()
...
class ConstraintMarkingMenuCommand(menu.MarkingMenuCommand):
    ...
    .. code-block:: python
        ...
        cgrigMenu.MarkingMenu.buildFromLayout("markingMenu.constraint",
    ...
    def execute(self, arguments):
        ...
        elif operation == "constraintToolbox":
            run.openToolset("constraintToolbox")
        elif operation == "matchBakeAnim":
            run.openToolset("matchBakeAnim")
