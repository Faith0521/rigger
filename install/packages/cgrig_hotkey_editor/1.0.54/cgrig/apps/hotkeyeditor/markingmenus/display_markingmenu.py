...
class DisplayMMenu(object):
    def __init__(self, ctrlModifier=False, altModifier=False, shiftModifier=False):
        ...
        Bind the following code to a Maya hotkey "Press", set the modifier keys to match the hotkey being used:
            ...
            from cgrig.libs.maya.cmds.hotkeys import display_markingmenu
            cgrigDisplayMarkingMenuInstance = display_markingmenu.pressHotkey(ctrlModifier=False, altModifier=False,
                                                                            shiftModifier=False)
            cgrigDisplayMarkingMenuInstance.displayMMenu()

        Bind the following code to a Maya hotkey "Release":

            from cgrig.libs.maya.cmds.hotkeys import display_markingmenu
            cgrigDisplayMarkingMenuInstance.releaseHotkey()
            del cgrigDisplayMarkingMenuInstance
