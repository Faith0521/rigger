...
Hotkey found at cgrig.libs.maya.cmds.hotkeys.definedhotkeys.py
...
from cgrig.libs.maya.cmds.animation import bakeanim
...
MT_TRACKER_INST = motiontrail.CgRigMotionTrailTrackerSingleton()
ANIM_TRACKER_INST = generalanimation.CgRigAnimationTrackerSingleton()
...
class AnimationMarkingMenuCommand(menu.MarkingMenuCommand):
    ...
    .. code-block:: python
        ...
        cgrigMenu.MarkingMenu.buildFromLayout("markingMenu.animation",
    ...
    def execute(self, arguments):
        ...
        if operation == "createMotionTrails":
            ...
            definedhotkeys.open_tweenMachinePopup(cursorOnSlider=False, clickOffClose=False, closeOnRelease=False)
