...
from cgrig.libs.maya.cmds.lighting import lightsmultihdri, lightingutils, lightsmultiarea, lightconstants, \
    lightsmultidirectional
from cgrig.libs.maya.cmds.renderer import multirenderersettings, rendererload
...
LIGHT_TRACKER_INST = lightingutils.CgRigLightsTrackerSingleton()  # tracks LIGHT_TRACKER_INST.lightCreateOption (bool)
...
class lightsMarkingMenuCommand(menu.MarkingMenuCommand):
    ...
    .. code-block:: python
        ...
        cgrigMenu.MarkingMenu.buildFromLayout("markingMenu.lights",
                                            "lightsMarkingMenu",
    ...
    def execute(self, arguments):
        ...
        if operation == "areaLight":
            ...
            openLightEditor()
        elif operation == "cgrigEditLights":
        ...
        # Place Lights ----------------
            ...
            # os.environ["CGRIG_LIGHT_CREATEOPTION"] = str(int(not int(os.environ["CGRIG_LIGHT_CREATEOPTION"])))
