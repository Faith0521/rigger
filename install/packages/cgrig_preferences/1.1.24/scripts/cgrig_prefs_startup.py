...
Shutdown function
    bakes currently installed preference roots to main cgrigtools config path.
"""
import logging
...
def startup(package):
    """ Run commands on cgrig_preferences start up
    ...
    default = preference.defaultPreferenceSettings("cgrig_preferences", "global/stylesheet")
