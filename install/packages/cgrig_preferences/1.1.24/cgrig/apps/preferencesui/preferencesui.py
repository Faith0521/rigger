...
class PreferencesUI(elements.CgRigWindow):
    windowSettingsPath = "cgrig/preferencesui"
    def __init__(self, title="CgRig Preferences",
                 width=850,
...
class PrefTreeView(treeviewplus.TreeViewPlus):
    ...
    def onSelectionChangedEvent(self, event):
        ...
        :param event:
        :type event: cgrig.libs.pyqt.extended.treeviewplus.TreeViewPlusSelectionChangedEvent
        :return:
        :rtype:
        """
