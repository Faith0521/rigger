...
class PrefModel(QtCore.QObject):
    ...
    def reload(self):
        ...
        if self.pluginManager.plugins:
            ...
            return
        # loop the cgrigtools package preferences and find the widgets
        pluginPaths = set()
...
class SettingWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, setting=None):
        ...
        :type setting: cgrig.apps.preferencesui.prefmodel.SettingDataSource
        """
...
class SettingDataSource(datasources.BaseDataSource):
    def __init__(self, label, widget, model=None, parent=None):
        ...
        :type label:
        :param widget:
        :type widget: cgrig.apps.preferencesui.prefmodel.SettingWidget
        :param model:
        :type model:
        :param parent:
        :type parent:
    ...
    def widget(self):
        ...
        :return:
        :rtype: cgrig.apps.preferencesui.prefmodel.SettingWidget
        """
        return self._widget
