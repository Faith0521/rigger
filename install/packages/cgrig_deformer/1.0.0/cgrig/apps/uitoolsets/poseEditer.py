...
class PoseEditerUI(toolsetwidget.ToolsetWidget):
    id = "poseEditerTool"
    info = "BlendShape And SDK Editer for Pose Driver/UE RBF Driver."
    uiData = {"label": "Pose Editer Tool",
              "icon": "brick",
              "tooltip": "Pose Editer GUI.",
    ...
    def buttonPressed(self):
        """Method run on button clicked

        self.properties.aLabelAndTextbox.value is the str value from the widget self.aLabelAndTextbox
        """
        print("Button has been pressed with `{}` in the text box".format(self.properties.aLabelAndTextbox.value),)
