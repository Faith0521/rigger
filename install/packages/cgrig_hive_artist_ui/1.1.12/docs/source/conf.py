...
os.environ["CGRIG_PACKAGE_REPOS"] = root
os.environ["CGRIG_PRESET_PATH"] = os.path.join(root, "cgrigtools_version.config")
sys.path.append(root)

import packageresolver

resolved, cfg = packageresolver.resolveFromConfigFile(os.getenv("CGRIG_PRESET_PATH"), bakeEnv=True)
