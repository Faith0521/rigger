...
from cgrig.libs.pyqt.widgets import flowtoolbar
...
class HiveToolbar(flowtoolbar.FlowToolBar):
    ...
    def buttonClicked(self, wgt, name):
        ...
        :return:
        """
        tool = wgt.property("tool")  # type: cgrig.apps.hiveartistui.hivetool.HiveTool
    ...
    def addTool(self, hiveTool):
        ...
        tool = hiveTool(logger, parent=self,
                        uiInterface=self.core.uiInterface)  # type: cgrig.apps.hiveartistui.hivetool.HiveTool
