from cgrig.apps.hiveartistui.views import hivetoolbar
from cgrig.apps.toolsetsui import registry
from cgrig.apps.toolsetsui.widgets import toolsetframe
from cgrig.libs import iconlib
from cgrig.libs.pyqt import utils
from cgrig.libs.pyqt.widgets import elements
from cgrig.libs.pyqt.widgets import roundbutton
...
class VerticalToolBar(QtWidgets.QFrame):
    def __init__(self, parent=None, core=None, themePref=None, sidePanel=None, resizerWidget=None, toolsetGroup="",
        ...
        :param resizerWidget:
        :type resizerWidget: :class:`cgrig.libs.pyqt.widgets.resizerwidget.ResizerWidget`
        :param toolsetGroup:
        :type toolsetGroup:
        """
    ...
    def setResizerWidget(self, resizerWidget):
        ...
        :param resizerWidget:
        :type resizerWidget:  cgrig.libs.pyqt.widgets.resizerwidget.ResizerWidget
        :return:
        :rtype:
        """
        self.resizerWidget = resizerWidget
