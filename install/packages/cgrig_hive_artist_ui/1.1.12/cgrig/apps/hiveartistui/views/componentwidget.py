...
from cgrig.apps.hiveartistui import model, hivetool
from cgrig.apps.hiveartistui.views import componentsettings
from cgrig.apps.hiveartistui.views.widgethelpers import SideNameWidget
...
from cgrig.libs.pyqt.widgets import buttons
from cgrig.libs.pyqt.widgets import elements
from cgrig.libs.pyqt.widgets import iconmenu, stackwidget
...
class ComponentWidget(stackwidget.StackItem):
    syncRequested = QtCore.Signal(bool)
    ...
    def __init__(self, componentModel, parent, core):
        ...
        :type core: cgrig.apps.hiveartistui.artistuicore.HiveUICore
        :type parent: cgrig.apps.hiveartistui.views.componenttree.ComponentTreeWidget
