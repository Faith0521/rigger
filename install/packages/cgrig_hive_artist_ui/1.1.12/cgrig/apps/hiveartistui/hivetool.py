...
class HiveTool(QtCore.QObject):
    ...
    def __init__(self, logger, uiInterface):
        ...
        :param uiInterface:
        :type uiInterface: :class:`cgrig.apps.hiveartistui.uiinterface.UiInterface`
        """
    ...
    def rigModel(self):
        ...
        :return:
        :rtype: cgrig.apps.hiveartistui.model.RigModel
        """
    ...
    def rigModel(self, value):
        ...
        :param value:
        :type value: cgrig.apps.hiveartistui.model.RigModel
        :rtype:
        """
    ...
    def refreshAll(self, force=False):
        """ Refresh Everything in the rig.

        :return:
        """
        self.uiInterface.refreshUi(force)
