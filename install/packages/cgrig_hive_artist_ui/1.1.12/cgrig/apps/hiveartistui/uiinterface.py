...
class UiInterface(QtCore.QObject):
    ...
    def __init__(self, parent=None):
        ...
        # :type artistUi: :class:`cgrig.apps.hiveartistui.artistui.HiveArtistUI`
        # :param tree:
        # :type tree:  :class:`cgrig.apps.hiveartistui.views.componenttree.ComponentTreeWidget`
        """
    ...
    def core(self):
        ...
        :return:
        :rtype: :class:`cgrig.apps.hiveartistui.artistuicore.HiveUICore`
        """
        return self._core
    ...
    def setCore(self, core):
        ...
        :param core:
        :type core: :class:`cgrig.apps.hiveartistui.artistuicore.HiveUICore`
        """
        self._core = core
    ...
    def templateLibrary(self):
        ...
        :return:
        :rtype: :class:`cgrig.apps.hiveartistui.views.templatelibrary.TemplateLibrary
        """
    ...
    def tree(self):
        ...
        :return:
        :rtype: :class:`cgrig.apps.hiveartistui.views.componenttree.ComponentTreeWidget`
        """
    ...
    def artistUi(self):
        ...
        :return:
        :rtype: :class:`cgrig.apps.hiveartistui.artistui.HiveArtistUI`
        """
