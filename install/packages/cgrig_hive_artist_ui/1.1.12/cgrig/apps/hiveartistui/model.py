...
class ComponentModel(QtCore.QObject):
    ...
    def __init__(self, component=None, rigModel=None):
        ...
        :param component:
        :type component: cgrig.libs.hive.base.component.Component
    ...
    @property
    def component(self):
        self._component = self.rigModel.rig.component(self._component.name(), self._component.side())
