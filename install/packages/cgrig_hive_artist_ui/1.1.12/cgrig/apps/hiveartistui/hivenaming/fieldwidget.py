...
from cgrig.libs.pyqt.extended import tableviewplus, listviewplus
from cgrig.libs.pyqt.models import tablemodel, listmodel, datasources, modelutils
...
class FieldsWidget(QtWidgets.QSplitter):
    ...
    def reloadFromConfig(self, configInstance):
        ...
        :type configInstance: :class:`cgrig.libs.naming.naming.NameManager`
        """
