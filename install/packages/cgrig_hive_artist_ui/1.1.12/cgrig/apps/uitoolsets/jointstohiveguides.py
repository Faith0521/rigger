...
from cgrig.libs.maya.cmds.objutils import joints, objhandling
from cgrig.libs.hive.base.util import fkutils
...
class JointsToHiveGuides(toolsetwidget.ToolsetWidget):
    ...
    def sceneRigs(self):
        ...
        :return:
        :rtype: list[:class:`cgrig.libs.hive.base.rig.Rig`]
        """
    ...
    def jointsToHive(self):
        ...
        component = r.createComponent("fkchain", componentName, SIDE_DICT[side])

        fkutils.transformsToFkGuides(r, component, zapiJnts,
...
class GuiWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        self.scaleFloat = elements.FloatEdit(label="Scale",
                                             ...
                                             toolTip=toolTip)
        # Side Combo -----------------------------
        field = hiveapi.Configuration().findNamingConfigForType("cgrigtoolsProGlobalConfig").field("side")
