# -*- coding: utf-8 -*-
from cgrig.libs.pyqt.extended.imageview.thumbnail import minibrowserpathlist
...
class CgRigControlsJointsPrefsWidget(prefmodel.SettingWidget):
    ...
    def __init__(self, parent=None, setting=None):
        ...
        """
        super(CgRigControlsJointsPrefsWidget, self).__init__(parent, setting)
    ...
    def uiWidgets(self):
        ...
        toolTip = "The location of the Controls Joints. \n" \
                  "Copy your *.cgrigScene files along with their dependency folders into the root of this folder. "
    ...
    def serialize(self):
        ...
        output.displayInfo(
            "Success: Control joints preferences saved: '{}'".format(self.prefs.controlAssets.cgrigPrefsPath()))
    ...
    def adminSave(self):
        """Method for admin saving internally to CgRig Tools Pro, not connected
        """
        pass
