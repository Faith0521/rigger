...
from cgrig.apps.toolsetsui import toolsetcallbacks
from cgrig.libs.maya.cmds.objutils import joints, curves
...
class JointsOnCurve(toolsetwidget.ToolsetWidget):
    ...
    def jointsOnCurve(self):
        ...
        executor.execute("cgrig.maya.jointsAlongCurve.selected", jointCount=self.properties.jointCountInt.value,
    ...
    def rebuildJointsOnCurve(self, message=True, renameMode=False):
        ...
        upAxis = joints.AUTO_UP_VECTOR_WORDS_LIST[self.properties.upAxisCombo.value]
        # executor.execute("cgrig.maya.jointsAlongCurve.rebuild",
