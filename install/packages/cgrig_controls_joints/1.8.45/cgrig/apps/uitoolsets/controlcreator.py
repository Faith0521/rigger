...
from cgrig.apps.controlsjoints import controlsjointsconstants as cc, api
from cgrig.apps.controlsjoints.mixins import ControlsJointsMixin
from cgrig.apps.controlsjoints.modelcontrolcurves import ControlCurvesViewerModel
from cgrig.apps.toolsetsui.mixins import MiniBrowserMixin

from cgrig.preferences.interfaces import controljointsinterfaces
...
class ControlCreator(toolsetwidget.ToolsetWidget, MiniBrowserMixin, ControlsJointsMixin):
    ...
    def uiconnections(self):
        ...
        for uiInstance in self.widgets():
            ...
            uiInstance.toolDotsMenu.delCgRigTrackerAttrs.connect(self.delCgRigTrackerAttrs)
...
class AllWidgets(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None, directories=None):
        ...
        :param directories: directory path of the light preset cgrigScene files
...
class DotsMenu(IconMenuButton):
    ...
    delCgRigTrackerAttrs = QtCore.Signal()
    ...
    def __init__(self, parent=None):
        ...
        self.addAction("Delete CgRig Tracker Attrs", connect=lambda: self.delCgRigTrackerAttrs.emit(), icon=delAttrIcon)
