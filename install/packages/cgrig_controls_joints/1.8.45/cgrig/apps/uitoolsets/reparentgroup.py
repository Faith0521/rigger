...
from cgrig.libs.maya.cmds.rig import reparentgrouptoggle
...
class GuiWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        # Create ---------------------------------------
        tooltip = "Creates an empty group match to a selected object named `objName_cgrigParentToRig`.  \n" \
        ...
        # Parent All In Scene ---------------------------------------
        tooltip = "Parents all groups in the scene with the suffix `*_cgrigParentToRig` to their \n" \
        ...
        tooltip = "Unparents all groups in the scene with the suffix `*_cgrigParentToRig` to the world. \n\n" \
                  "This script relies on naming, all objects must have unique short names."
