...
from cgrig.libs.maya.utils.mayacolors import MAYA_COLOR_SRGB
from cgrig.libs.maya.cmds.objutils import objcolor, filtertypes, shapenodes
...
from cgrig.libs.utils.colors.colorpalettes import PASTEL_PALETTE, NEON_PALETTE, CAMPFIRE_PALETTE, CONTRAD_PALETTE, \
