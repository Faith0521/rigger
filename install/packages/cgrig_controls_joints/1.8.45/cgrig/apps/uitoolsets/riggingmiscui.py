...
from cgrig.libs.maya.cmds.objutils import alignutils, locators
from cgrig.libs.maya.cmds.rig import riggingmisc, follicles
...
class GuiWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        toolTip = "Match Objects Options \n" \
                  ...
                  "CgRig Hotkey: shift v (marking menu)"
