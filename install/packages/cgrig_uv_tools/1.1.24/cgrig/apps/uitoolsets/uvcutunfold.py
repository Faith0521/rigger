...
from cgrig.libs.maya.cmds.objutils import uvtransfer
from cgrig.libs.maya.cmds.uvs import uvmacros, uvfunctions
...
class GuiWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        toolTip = "Symmetry Brush mirrors shells with a brush paint. \n" \
                  "CgRig version automatically finds the shell symmetry direction and pivot \n" \
