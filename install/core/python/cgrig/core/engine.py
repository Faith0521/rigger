...
class Engine(object):
    ...
    It's designed to load cgrigtools in a DCC specific way,
    ...
    def init(self):
        ...
        # todo: load the cgrigtools environment ie. packages
    ...
    def dialogsByName(self, name):
        ...
        :type name: str
        :return: A list of Dialogs, windows, cgrig windows which match the  registered name
...
def startEngine(config, engineCls, engineName):
    ...
    :rtype: Engine
"""
    logger.info("Loading CgRig Tools PRO, please wait!")
