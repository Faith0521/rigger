...
from cgrig.core import errors, constants
from cgrig.core.util import version as cgrigversion
from cgrig.core.util import zlogging
from cgrig.core.util import env, filesystem, modules
from cgrig.core.packageresolver import requirements
...
class Package(object):
    ...
    def __init__(self, packagePath=None):
        ...
        # cached environment
        self.cache = {}
        self.version = cgrigversion.LooseVersion()
        self.name = ""
        self.displayName = ""
        self.description = ""
        self.author = ""
    ...
    def setVersion(self, versionStr):
        self.version = cgrigversion.LooseVersion(versionStr)
    ...
    def processData(self, data):
        ...
        self.version = cgrigversion.LooseVersion(data.get("version", ""))
