...
from cgrig.core.util import pathutils, filesystem, classtypes
...
class ToolSet(object):
    ...
    .. code-block:: python
        ...
        tset.addRoot(os.path.expanduser("~/Documents/maya/2018/scripts/cgrigtools_preferences"), "userPreferences")
