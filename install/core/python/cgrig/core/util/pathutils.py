...
def filesByExtension(directory, extensionList, sort=True):
    ...
    Extension should be without the fullstop ie ["cgrigScene", "json", "jpg"]

    Return Example:
        ["soft_sunsetSides.cgrigScene", "sun_redHarsh.cgrigScene", "sun_warmGlow.cgrigScene"]

    :param directory: The directory to search and return filenames
    :type directory: str
    :param extensionList: A list of extensions to search ["cgrigScene", "json", "jpg"]
