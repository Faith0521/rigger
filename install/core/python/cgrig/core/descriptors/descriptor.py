...
class DescriptorRegistry(pluginmanager.PluginManager):
    ...
    This class is responsible for managing the descriptors used the cgrigtools environment.
    It loads descriptors from a cache generated from the CgRig class Instance, and it can generate
...
class Descriptor(plugin.Plugin):
    ...
    :param config: The cgrig config instance
    ...
    def package(self):
        """
        Returns the cgrig package instance attached to this descriptor or None

        :return: The cgrig package for the descriptor
        :rtype: :class:`cgrig.core.packageresolver.package.Package` or None
        """
    ...
    def package(self, pkg):
        ...
        :param pkg: The cgrig package for the descriptor
        :type pkg: :class:`cgrig.core.packageresolver.package.Package`
