# -*- coding: utf-8 -*-
#
# CgRigtools documentation build configuration file, created by
...
_CGRIGTOOLS_NAME = u"CgRigtools Pro"
...
sys.modules.update((mod_name, MockExt()) for mod_name in {
    "cgrigvendor.Qt",
    "cgrigvendor.Qt.QtGui",
    "cgrigvendor.Qt.QtCore",
    "cgrigvendor.Qt.QtWidgets",
    "cgrigvendor.Qt.QtGui",
    "cgrigvendor.Qt.QtCompat",
    "shiboken2",
    "shiboken2.shiboken2",
    "PySide2.QtGui",
    "PySide2.QtCore",
...
project = _CGRIGTOOLS_NAME
copyright = u'2020, David Sparrow'
author = u'David Sparrow'
html_logo = "./resources/cgrigToolsZ.png"
...
htmlhelp_basename = _CGRIGTOOLS_NAME + "Doc"
...
latex_documents = [
    (master_doc, u'CgRigtools.tex', _CGRIGTOOLS_NAME + " Documentation",
...
man_pages = [
    (master_doc, _CGRIGTOOLS_NAME, _CGRIGTOOLS_NAME + " Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, _CGRIGTOOLS_NAME, _CGRIGTOOLS_NAME + " Documentation",
     author, _CGRIGTOOLS_NAME, 'One line description of project.',
     'Miscellaneous'),
]
